...
type
  TLAPBudgetRealisasiFrm = class(TForm)
...
var
  LAPBudgetRealisasiFrm: TLAPBudgetRealisasiFrm;
...
procedure TLAPBudgetRealisasiFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  LAPBudgetRealisasiFrm:=Nil;
end;

procedure TLAPBudgetRealisasiFrm.FormShow(Sender: TObject);
begin
Mozilla.Refresh;
Mozilla.Navigate('192.168.1.225\budgeting_link\budgeting\LAP_REKAP_REALBUDGET.php');
