object ReturPembelianFrm: TReturPembelianFrm
  Left = 33
  Top = 114
  Width = 831
  Height = 734
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select a.* from vbrowse_hutang2 a'
      ':myparam')
    Variables.Data = {
  ...
  object QAwal: TOracleDataSet
    ...
    Variables.Data = {
      ...
      00003A4B445F5045524B030000000000000000000000}
  ...
  object QBukuKas: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select * from vbrowse_hutang2 where kas=:kd_perk_' +
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      ...
      'order by nama_item')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000001100000076697465
      6D5F73746F6B5F7574616D610000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QRekanan: TOracleDataSet
    SQL.Strings = (
        ...
        ' from rekanan a'
      'where isaktif='#39'1'#39' and a.jenis='#39'SUPLIER'#39
