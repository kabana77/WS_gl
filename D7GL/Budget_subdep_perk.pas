...
type
  TBudgetsubdepperkFrm = class(TForm)
...
var
  BudgetsubdepperkFrm: TBudgetsubdepperkFrm;
...
procedure TBudgetsubdepperkFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  BudgetsubdepperkFrm:=Nil;
end;

procedure TBudgetsubdepperkFrm.FormShow(Sender: TObject);
begin
Mozilla.Refresh;
Mozilla.Navigate('192.168.1.225\budgeting_link\budgeting\BUDGET_SUB_KDPERK.php');
