...
procedure TKendaraanFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TKendaraanFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TKendaraanFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TKendaraanFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TKendaraanFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TKendaraanFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TKendaraanFrm.QDetailAfterScroll(DataSet: TDataSet);
begin
//  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TKendaraanFrm.cbModeEditClick(Sender: TObject);
begin
...
procedure TKendaraanFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=Caption;
end;

procedure TKendaraanFrm.QBrowseNewRecord(DataSet: TDataSet);
begin
  QBrowseISAKTIF.AsString:='0';
end;

procedure TKendaraanFrm.LookDivisiEnter(Sender: TObject);
begin
DMFrm.QDivisi.Open;
end;
