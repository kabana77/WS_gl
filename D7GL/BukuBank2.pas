...
begin
  ...
  if QTransaksiJENIS.AsString='111' then
...
begin
  QBukuKas.SetVariable('kd_perk_kas',DMFrm.QBankKD_PERK.AsString);
...
procedure TBukuBank2Frm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  if LookJenis.Text='BBM' then
    QRLTitle2.Caption:='BANK MASUK'
    else
      QRLTitle2.Caption:='BANK KELUAR';
end;

procedure TBukuBank2Frm.TitleBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLAccount.Caption:=DMFrm.QBankKD_PERK.AsString+'/ '+DMFrm.QBankNAMA_PERKIRAAN.AsString;
...
procedure TBukuBank2Frm.LookDivisiEnter(Sender: TObject);
begin
  DMFrm.QDivisi.Open;
end;

procedure TBukuBank2Frm.LookBebanUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.QBeban.Close;
...
procedure TBukuBank2Frm.LookBebanUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.QBeban.Close;
...
procedure TBukuBank2Frm.QDetailKD_BEBANChange(Sender: TField);
begin
  QDetailKETERANGAN.AsString:=DMFrm.QBebanKETERANGAN.AsString;
end;

procedure TBukuBank2Frm.QDetailNO_PROYEKChange(Sender: TField);
begin
  QDetailKETERANGAN.AsString:=DMFrm.QProyekNAMA_PEKERJAAN.AsString;
end;

procedure TBukuBank2Frm.cbPostClick(Sender: TObject);
begin
...
procedure TBukuBank2Frm.QDetailBeforeEdit(DataSet: TDataSet);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TBukuBank2Frm.FormShow(Sender: TObject);
begin
  VTglAwal2.Date:=Date;
end;
