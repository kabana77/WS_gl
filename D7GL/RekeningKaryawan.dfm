object RekeningKaryawanFrm: TRekeningKaryawanFrm
  Left = 97
  Top = 137
  Width = 831
  Height = 734
  Caption = 'REKENING KRYAWAN DAN SALES'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          'NAMA_DIVISI'#9'9'#9'DIVISI'#9'F'
          'NAMA_KARYAWAN'#9'36'#9'NAMA_KARYAWAN'#9'F'
          'NIK'#9'10'#9'NIK'#9'F'
  ...
  object Panel4: TPanel
    ...
    object DBText1: TDBText
      ...
      DataSource = DMFrm.dsQPerkiraanAll
    end
  end
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      ...
      'a.jenis, '
      '1 as vcount,'
      'a.nama_divisi, b.awal, c.debet, c.kredit from vkaryawan_rek a '
      'left outer join (select p.nik, sum(p.debet-p.kredit) as awal '
      
        '  from jurnal p, kas q where p.kd_perk like :pkd_perk and p.no_k' +
        'as=q.no_kas and q.tanggal>=trunc(:pawal,'#39'YEAR'#39') and q.tanggal<tr' +
        'unc(:pawal)'
      '  group by p.nik) b on (a.nik=b.nik)'
      
        'left outer join (select p.nik, sum(p.debet) as debet, sum(kredit' +
        ') as kredit'
      
        '  from jurnal p, kas q where p.kd_perk like :pkd_perk and p.no_k' +
        'as=q.no_kas and q.tanggal>=trunc(:pawal) and q.tanggal<trunc(:pa' +
        'khir)+1-1/86400'
      '  group by p.nik) c on (a.nik=c.nik)  '
      ')'
      ':myparam')
    Variables.Data = {
      
      090000003A504B445F5045524B050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      4152594157414E010000000000}
