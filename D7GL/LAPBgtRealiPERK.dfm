object LAPBgtRealiPERKFRM: TLAPBgtRealiPERKFRM
  Left = 212
  Top = 133
  Width = 1024
  Height = 594
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet3: TTabSheet
      ...
      object Panel9: TPanel
        ...
        object Panel10: TPanel
          ...
          object lookDept: TwwDBLookupComboDlg
            ...
            MaxHeight = 209
            Selected.Strings = (
              'NAMA_DEPT'#9'37'#9'NAMA_DEPT'#9'F'#9
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'JAN'#9'10'#9'Budget'#9'F'#9'JAN'
          'JAN2'#9'10'#9'Realisasi'#9'F'#9'JAN'
          'var_jan'#9'10'#9'Sisa'#9'F'#9'JAN'
          'FEB'#9'10'#9'Budget'#9'F'#9'FEB'
          'FEB2'#9'10'#9'Realisasi'#9'F'#9'FEB'
          'var_feb'#9'10'#9'Sisa'#9'F'#9'FEB'
          'MAR'#9'10'#9'Budget'#9'F'#9'MAR'
          'MAR2'#9'10'#9'Realisasi'#9'F'#9'MAR'
          'var_mar'#9'10'#9'Sisa'#9'F'#9'MAR'
          'APR'#9'10'#9'Budget'#9'F'#9'APR'
          'APR2'#9'10'#9'Realisasi'#9'F'#9'APR'
          'var_apr'#9'10'#9'Sisa'#9'F'#9'APR'
          'MEI'#9'10'#9'Budget'#9'F'#9'MEI'
          'MEI2'#9'10'#9'Realisasi'#9'F'#9'MEI'
          'var_mei'#9'10'#9'Sisa'#9'F'#9'MEI'
          'JUN'#9'10'#9'Budget'#9'F'#9'JUN'
          'JUN2'#9'10'#9'Realisasi'#9'F'#9'JUN'
          'var_jun'#9'10'#9'Sisa'#9'F'#9'JUN'
          'JUL'#9'10'#9'Budget'#9'F'#9'JUL'
          'JUL2'#9'10'#9'Realisasi'#9'F'#9'JUL'
          'var_jul'#9'10'#9'Sisa'#9'F'#9'JUL'
          'AGS'#9'10'#9'Budget'#9'F'#9'AGS'
          'AGS2'#9'10'#9'Realisasi'#9'F'#9'AGS'
          'var_agt'#9'10'#9'Sisa'#9'F'#9'AGS'
          'SEP'#9'10'#9'Budget'#9'F'#9'SEP'
          'SEP2'#9'10'#9'Realisasi'#9'F'#9'SEP'
          'var_sep'#9'10'#9'Sisa'#9'F'#9'SEP'
          'OKT'#9'10'#9'Budget'#9'F'#9'OKT'
          'OKT2'#9'10'#9'Realisasi'#9'F'#9'OKT'
          'var_okt'#9'10'#9'Sisa'#9'F'#9'OKT'
          'NOV'#9'10'#9'Budget'#9'F'#9'NOV'
          'NOV2'#9'10'#9'Realisasi'#9'F'#9'NOV'
          'var_nov'#9'10'#9'Sisa'#9'F'#9'NOV'
          'DES'#9'10'#9'Budget'#9'F'#9'DES'
          'DES2'#9'10'#9'Realisasi'#9'F'#9'DES'
          'var_des'#9'10'#9'Sisa'#9'F'#9'DES')
    ...
    object TabSheet4: TTabSheet
      Caption = 'Check Daftar Biaya Belum Posting Budget'
      ImageIndex = 3
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        DittoAttributes.ShortCutDittoRecord = 16429
        Selected.Strings = (
          'KD_BIAYA'#9'17'#9'KODE~BIAYA'#9'F'
          'KETERANGAN'#9'100'#9'KETERANGAN'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Cipsoft_GL'
  ...
  object QRekapBudgetRealPerk: TOracleDataSet
    SQL.Strings = (
      'select * from cip_budgeting.vlaporan_realbudget'
      
        'where tahun=:Thn AND kd_perk like :kdperk and dep like :dep and ' +
        'sub_dept like :subdep'
      'order by tahun, kd_perk'
      '')
    Variables.Data = {
      0300000004000000040000003A54484E05000000000000000000000007000000
      3A4B445045524B050000000000000000000000040000003A4445500500000000
      00000000000000070000003A535542444550050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
    ...
    object QRekapBudgetRealPerkKD_BIAYA: TStringField
      FieldName = 'KD_BIAYA'
      Size = 25
    end
    ...
    object QRekapBudgetRealPerkvar_agt: TFloatField
      FieldKind = fkCalculated
      FieldName = 'var_agt'
      DisplayFormat = '#,##0.##;(#,##0.##)'
      Calculated = True
  ...
  object QTotal2: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(nov2) as nov2, '
      'sum(des2) as des2'
      'from cip_budgeting.vlaporan_realbudget'
      
        'where tahun=:Thn AND kd_perk like :kdperk and dep like :dep and ' +
        'sub_dept like :subdep')
    Variables.Data = {
      0300000004000000040000003A54484E05000000050000003230313300000000
      00070000003A4B445045524B050000000000000000000000070000003A535542
      444550050000000000000000000000040000003A444550050000000000000000
      000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QProses: TOracleQuery
    SQL.Strings = (
      'begin'
      '   cip_budgeting.proc_isi_lap_realbudget_u(:puser);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {0300000001000000060000003A5055534552050000000000000000000000}
    Left = 576
    Top = 200
  end
  object QProses1: TOracleQuery
    SQL.Strings = (
      'begin'
      '   cip_budgeting.proc_isi_riwayat_transaksi(:puser);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {0300000001000000060000003A5055534552050000000000000000000000}
  ...
  object QDetRealPerk: TOracleDataSet
    SQL.Strings = (
      'select * from cip_budgeting.riwayat_transaksi_tmp '
      
        'where tahun=:Thn AND kd_perk like :kdperk and nama_dept like :de' +
        'p and sub_dept like :subdep'
      'order by tanggal, nama_dept')
    Variables.Data = {
      0300000004000000040000003A54484E05000000000000000000000007000000
      3A4B445045524B050000000000000000000000040000003A4445500500000000
      00000000000000070000003A535542444550050000000000000000000000}
  ...
  object QTotal6: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(realisasi) as realisasi from cip_budgeting.riwayat_tr' +
        'ansaksi_tmp'
    ...
    Variables.Data = {
      0300000004000000040000003A54484E05000000050000003230313300000000
      00070000003A4B445045524B050000000000000000000000040000003A444550
      050000000000000000000000070000003A535542444550050000000000000000
      000000}
  ...
  object QRekapDepartemen: TOracleDataSet
    SQL.Strings = (
      ...
      'tahun, dep, kd_perk) a, cip_budgeting.perkiraan b'
        ...
        'where a.kd_perk=b.kd_perk and tahun=:Thn AND a.kd_perk like :kdp' +
        'erk and a.dep like :dep '
      'order by a.tahun,a.dep,a.kd_perk')
    Variables.Data = {
      0300000003000000040000003A54484E05000000000000000000000007000000
      3A4B445045524B050000000000000000000000040000003A4445500500000000
      00000000000000}
    QBEDefinition.QBEFieldDefs = {
    ...
    object QRekapDepartemenvar_agt: TFloatField
      FieldKind = fkCalculated
      FieldName = 'var_agt'
      DisplayFormat = '#,##0.##;(#,##0.##)'
      Calculated = True
    ...
    object QRekapDepartemenAWAL: TFloatField
      FieldName = 'AWAL'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
    ...
    object QRekapDepartemenAWAL2: TFloatField
      FieldName = 'AWAL2'
      DisplayFormat = '#,##0.##;(#,##0.##)'
    end
  ...
  object QTotDep: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(des2) as des2'
      'from cip_budgeting.vlaporan_realbudget'
      'where tahun=:Thn AND kd_perk like :kdperk and dep like :dep')
    Variables.Data = {
