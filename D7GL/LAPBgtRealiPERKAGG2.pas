...
type
  TLAPBgtRealiPERKAGG2FRM = class(TForm)
    Panel1: TPanel;
    ...
    QRekapDepartemenVAR_AGS: TFloatField;
    ...
    QRekapDepartemenVAR_AKHIR: TFloatField;
    ...
    QRekapBudgetRealPerkVAR_AGS: TFloatField;
    ...
    QRekapBudgetRealPerkAKHIR: TFloatField;
    QRekapBudgetRealPerkAKHIR2: TFloatField;
    QRekapBudgetRealPerkVAR_AKHIR: TFloatField;
    SpinEdit1: TSpinEdit;
    Label10: TLabel;
...
var
  LAPBgtRealiPERKAGG2FRM: TLAPBgtRealiPERKAGG2FRM;
...
procedure TLAPBgtRealiPERKAGG2FRM.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  LAPBgtRealiPERKAGG2FRM:=Nil;
end;

procedure TLAPBgtRealiPERKAGG2FRM.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TLAPBgtRealiPERKAGG2FRM.BitBtn5Click(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.TabSheet1Show(Sender: TObject);
//VAR
//vTOT:REAL;
begin
{QProses1.Close;
...
procedure TLAPBgtRealiPERKAGG2FRM.vHeightAfterUpClick(Sender: TObject);
begin
  //case PageControl1.ActivePageIndex of
...
procedure TLAPBgtRealiPERKAGG2FRM.BtnExportClick(Sender: TObject);
begin
case pagecontrol1.ActivePageIndex of
 0 :
  begin
...
procedure TLAPBgtRealiPERKAGG2FRM.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.QDetailAfterScroll(DataSet: TDataSet);
begin
//  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TLAPBgtRealiPERKAGG2FRM.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  tanggalan : string;
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  tanggalan : string;
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  //QRImage1.Picture.Assign(DMFrm.vlogo.Picture);
end;

procedure TLAPBgtRealiPERKAGG2FRM.BitBtn3Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses1.Close;
QProses1.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses1.SetVariable('panggaran','ANGGARAN OPERASIONAL');
...
//  QTOTAL6.SetVariable('subdep','%'+edCari4.Text+'%');
  ...
  MessageDlg('Proses Detail Laporan Realisasi Anggaran Departemen - Selesai.', mtInformation,[mbOk], 0);
...
procedure TLAPBgtRealiPERKAGG2FRM.TabSheet2Show(Sender: TObject);
begin
{QRekapBudgetRealPerk.Close;
QRekapBudgetRealPerk.Open;
{QRealisasiBgt.Close;
QRealisasiBgt.Open;   }
spTahun2.Value:=STRTOINT(FORMATDATETIME('YYYY',DATE));
end;

procedure TLAPBgtRealiPERKAGG2FRM.et3Show(Sender: TObject);
begin
//QRekapDepartemen.Close;
//QRekapDepartemen.Open;
spTahun3.Value:=STRTOINT(FORMATDATETIME('YYYY',DATE));
end;

procedure TLAPBgtRealiPERKAGG2FRM.BitBtn4Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses.Close;
QProses.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses.SetVariable('panggaran','ANGGARAN OPERASIONAL');
...
QProses.Execute;
 ...
 QRekapDepartemen.DisableControls;
 QRekapDepartemen.Close;
...
//  QTotDep.SetVariable('dep','%'+edCari3.Text+'%');
 ...
 // ;
   vTOT:=vakhir;     }
   wwDBGrid2.ColumnByName('TOTAL').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepTOTAL.ASFLOAT);
   wwDBGrid2.ColumnByName('JAN').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepJAN.ASFLOAT);
   wwDBGrid2.ColumnByName('FEB').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepFEB.ASFLOAT);
   wwDBGrid2.ColumnByName('MAR').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepMAR.ASFLOAT);
   wwDBGrid2.ColumnByName('APR').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepAPR.ASFLOAT);
   wwDBGrid2.ColumnByName('MEI').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepMEI.ASFLOAT);
   wwDBGrid2.ColumnByName('JUN').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepJUN.ASFLOAT);
   wwDBGrid2.ColumnByName('JUL').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepJUL.ASFLOAT);
   wwDBGrid2.ColumnByName('AGS').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepAGS.ASFLOAT);
   wwDBGrid2.ColumnByName('SEP').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepSEP.ASFLOAT);
   wwDBGrid2.ColumnByName('OKT').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepOKT.ASFLOAT);
   wwDBGrid2.ColumnByName('NOV').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepNOV.ASFLOAT);
   wwDBGrid2.ColumnByName('DES').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepDES.ASFLOAT);
   wwDBGrid2.ColumnByName('JAN2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepJAN2.ASFLOAT);
   wwDBGrid2.ColumnByName('FEB2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepFEB2.ASFLOAT);
   wwDBGrid2.ColumnByName('MAR2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepMAR2.ASFLOAT);
   wwDBGrid2.ColumnByName('APR2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepAPR2.ASFLOAT);
   wwDBGrid2.ColumnByName('MEI2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepMEI2.ASFLOAT);
   wwDBGrid2.ColumnByName('JUN2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepJUN2.ASFLOAT);
   wwDBGrid2.ColumnByName('JUL2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepJUL2.ASFLOAT);
   wwDBGrid2.ColumnByName('AGS2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepAGS2.ASFLOAT);
   wwDBGrid2.ColumnByName('SEP2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepSEP2.ASFLOAT);
   wwDBGrid2.ColumnByName('OKT2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepOKT2.ASFLOAT);
   wwDBGrid2.ColumnByName('NOV2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepNOV2.ASFLOAT);
   wwDBGrid2.ColumnByName('DES2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepDES2.ASFLOAT);
   wwDBGrid2.ColumnByName('TOTAL2').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepTOTAL2.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_JAN').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepvar_jan.AsFloaT);
   wwDBGrid2.ColumnByName('VAR_FEB').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_FEB.AsFloaT);
   wwDBGrid2.ColumnByName('VAR_MAR').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_MAR.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_APR').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_APR.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_MEI').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_MEI.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_JUN').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_JUN.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_JUL').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_JUL.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_AGT').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_AGT.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_SEP').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_SEP.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_OKT').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_OKT.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_NOV').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_NOV.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_DES').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_DES.ASFLOAT);
   wwDBGrid2.ColumnByName('VAR_TOT').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QTotDepVAR_TOT.ASFLOAT);

  MessageDlg('Proses Laporan Realisasi Anggaran Departemen - Selesai.', mtInformation,[mbOk], 0);

end;

procedure TLAPBgtRealiPERKAGG2FRM.QRekapBudgetRealPerkCalcFields(DataSet: TDataSet);
begin
{ JHN }
...
QRekapBudgetRealPerkvar_ags.AsFloat:=QRekapBudgetRealPerkags.AsFloat-QRekapBudgetRealPerkags2.AsFloat;
...
procedure TLAPBgtRealiPERKAGG2FRM.QRealisasiBgtCalcFields(DataSet: TDataSet);
begin
{azmi}
...
procedure TLAPBgtRealiPERKAGG2FRM.CheckBox1Click(Sender: TObject);
begin
 // QBrowse.Filtered:=CheckBox1.Checked;
end;

procedure TLAPBgtRealiPERKAGG2FRM.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=((QBrowseBIAYA_BGT.AsFloat)>0);
end;

procedure TLAPBgtRealiPERKAGG2FRM.BitBtn2Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses2.Close;
QProses2.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses2.SetVariable('panggaran','ANGGARAN OPERASIONAL');
QProses2.SetVariable('ptahun',Round(spTahun2.Value));
QProses2.SetVariable('pkdperk','%'+edCari6.Text);
QProses2.SetVariable('pdept','%'+edCari1.Text);
QProses2.SetVariable('psubdept','%'+edCari2.Text+'%');
     //  QProses.SetVariable('pakhir',VTglAkhir2.Date);
QProses2.Execute;

 QRekapBudgetRealPerk.DisableControls;
 QRekapBudgetRealPerk.Close;
...
//  QTOTAL2.SetVariable('subdep','%'+edCari2.Text+'%');
 ...
 // ;
  ...
  MessageDlg('Proses Laporan Realisasi Anggaran Departemen dan Sub.Departemen - Selesai.', mtInformation,[mbOk], 0);   
  {
  QBrowse4.Close;
...
procedure TLAPBgtRealiPERKAGG2FRM.CheckBox2Click(Sender: TObject);
begin
 // QBrowse4.Filtered:=CheckBox2.Checked;
end;

procedure TLAPBgtRealiPERKAGG2FRM.QBrowse4FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=((QBrowse4REALISASI.AsFloat)>0);
end;

procedure TLAPBgtRealiPERKAGG2FRM.TabSheet4Show(Sender: TObject);
begin
{QDaftarBiaya.Close;
QDaftarBiaya.Open;
...
procedure TLAPBgtRealiPERKAGG2FRM.BitBtn6Click(Sender: TObject);
begin
  edCari3.Clear;
  edCari5.Clear;
 // edCari4.Clear;
...
procedure TLAPBgtRealiPERKAGG2FRM.CheckBox3Click(Sender: TObject);
begin
 // QBrowse5.Filtered:=CheckBox3.Checked;
end;

procedure TLAPBgtRealiPERKAGG2FRM.QTotal2CalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.LookPerkiraanEnter(Sender: TObject);
begin
  QPerkBudget.Open;
end;

procedure TLAPBgtRealiPERKAGG2FRM.lookDeptClick(Sender: TObject);
begin
   lookDept.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
   lookDept2.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
end;

procedure TLAPBgtRealiPERKAGG2FRM.lookDeptCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.lookDeptEnter(Sender: TObject);
begin
    DMFrm.QLook_Dept.Open;
end;

procedure TLAPBgtRealiPERKAGG2FRM.lookSubDeptClick(Sender: TObject);
begin
    lookDept.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
    lookDept2.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
end;

procedure TLAPBgtRealiPERKAGG2FRM.lookSubDeptCloseUp(Sender: TObject;
...
procedure TLAPBgtRealiPERKAGG2FRM.lookSubDeptEnter(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.Button1Click(Sender: TObject);
begin
  edCari1.Clear;
  edCari2.Clear;
  edCari6.Clear;
...
procedure TLAPBgtRealiPERKAGG2FRM.QRekapDepartemenCalcFields(
  DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.QTotDepCalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.wwDBGrid4DblClick(Sender: TObject);
var
...
procedure TLAPBgtRealiPERKAGG2FRM.BitBtn1Click(Sender: TObject);
begin
QProsesBReal.Close;
...
procedure TLAPBgtRealiPERKAGG2FRM.LookPerkiraanCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
edCari5.Text:=QPerkBudgetKD_PERK.AsString;
end;

procedure TLAPBgtRealiPERKAGG2FRM.LookPerkiraan2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
edCari6.Text:=QPerkBudgetKD_PERK.AsString;
end;

procedure TLAPBgtRealiPERKAGG2FRM.SpinEdit1Change(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG2FRM.wwDBGrid3DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
