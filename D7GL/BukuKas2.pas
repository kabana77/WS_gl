...
procedure TBukuKas2Frm.FormClose(Sender: TObject;
...
procedure TBukuKas2Frm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TBukuKas2Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TBukuKas2Frm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TBukuKas2Frm.ECariChange(Sender: TObject);
begin
...
procedure TBukuKas2Frm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TBukuKas2Frm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vdebet, vkredit : real;
...
procedure TBukuKas2Frm.BitBtn5Click(Sender: TObject);
begin
...
procedure TBukuKas2Frm.TabSheet1Show(Sender: TObject);
begin
...
procedure TBukuKas2Frm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TBukuKas2Frm.BtnExportClick(Sender: TObject);
begin
...
procedure TBukuKas2Frm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TBukuKas2Frm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TBukuKas2Frm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBukuKas2Frm.QDetailAfterScroll(DataSet: TDataSet);
begin
//  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TBukuKas2Frm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TBukuKas2Frm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  if DMFrm.QKas.Active then
    QTransaksiKD_PERK.AsString:=DMFrm.QKasKD_PERK.AsString;
  QTransaksiTANGGAL.AsDateTime:=Date;
  QTransaksiJENIS.AsString:='104';
  QTransaksiKETERANGAN.AsString:='-';
  QTransaksiISPOST.AsString:='0';
//  QTransaksiKD_PERK.AsString:='11102';
  LookKas.SetFocus;
end;

procedure TBukuKas2Frm.DBMemo1KeyPress(Sender: TObject; var Key: Char);
begin
   if Key = #13 then
...
procedure TBukuKas2Frm.wwDBDateTimePicker1KeyPress(Sender: TObject;
  var Key: Char);
begin
   if Key = #13 then
   begin
...
procedure TBukuKas2Frm.QTransaksiBeforePost(DataSet: TDataSet);
begin
//  QTransaksiKD_PERK.AsString:='11102';
...
procedure TBukuKas2Frm.TabSheet2Show(Sender: TObject);
begin
  DMFrm.QKas.Open;
  DMFrm.QProyek.Open;
  DMFrm.QRAB.Open;
...
procedure TBukuKas2Frm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TBukuKas2Frm.wwDBGrid2Enter(Sender: TObject);
begin
  if QTransaksi.State<>dsBrowse then QTransaksi.Post;
end;

procedure TBukuKas2Frm.QDetailNewRecord(DataSet: TDataSet);
begin
  if vno_bukti<>'' then
...
//  QDetailKREDIT.AsFloat:=0;
  ...
  if (QTransaksiJENIS.AsString='101') or (QTransaksiJENIS.AsString='103') then
    QDetailKD_CASH.AsString:=DMFrm.ckd_cash_in_unpost
    else
     QDetailKD_CASH.AsString:=DMFrm.ckd_cash_ot_unpost;

end;

procedure TBukuKas2Frm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TBukuKas2Frm.LookProyekEnter(Sender: TObject);
begin
  DMFrm.QProyek.Open;
end;

procedure TBukuKas2Frm.LookRABEnter(Sender: TObject);
begin
  DMFrm.QRab.Close;
...
procedure TBukuKas2Frm.QDetailKD_RABChange(Sender: TField);
begin
...
procedure TBukuKas2Frm.LookCashflowEnter(Sender: TObject);
begin
  DMFrm.QCashflow.Open;
end;

procedure TBukuKas2Frm.LookPerkiraanEnter(Sender: TObject);
begin
  DMFrm.QPerkiraan.Open;
end;

procedure TBukuKas2Frm.LookRABUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  LookupTable.Close;
  LookupTable.Open;
...
procedure TBukuKas2Frm.QTransaksiAfterScroll(DataSet: TDataSet);
begin
  if QDetail.Active then
    wwDBGrid2UpdateFooter(nil);
end;

procedure TBukuKas2Frm.LookKasEnter(Sender: TObject);
begin
  DMFrm.QKas.Open;
end;

procedure TBukuKas2Frm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBukuKas2Frm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBukuKas2Frm.QAwalBeforeOpen(DataSet: TDataSet);
begin
  QAwal.SetVariable('pawal',trunc(VTglAwal.Date));
  QAwal.SetVariable('kd_perk',DMFrm.QKasKD_PERK.AsString);
end;

procedure TBukuKas2Frm.QBukuKasBeforeOpen(DataSet: TDataSet);
begin
...
procedure TBukuKas2Frm.BitBtn2Click(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  QAwal.Close;
...
procedure TBukuKas2Frm.TabSheet3Show(Sender: TObject);
begin
  DMFrm.QKas.Open;
...
procedure TBukuKas2Frm.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TBukuKas2Frm.DetailBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
...
procedure TBukuKas2Frm.TitleBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TBukuKas2Frm.TitleBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TBukuKas2Frm.SummaryBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TBukuKas2Frm.VTglAwal2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TBukuKas2Frm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TBukuKas2Frm.cbTanggalClick(Sender: TObject);
begin
  if cbTanggal.Checked then
  begin
...
procedure TBukuKas2Frm.LookDivisiEnter(Sender: TObject);
begin
  DMFrm.QDivisi.Open;
end;

procedure TBukuKas2Frm.QDetailKD_BEBANChange(Sender: TField);
begin
  QDetailKETERANGAN.AsString:=DMFrm.QBebanKETERANGAN.AsString;
end;

procedure TBukuKas2Frm.QDetailNO_PROYEKChange(Sender: TField);
begin
  QDetailKETERANGAN.AsString:=DMFrm.QProyekNAMA_PEKERJAAN.AsString;
end;

procedure TBukuKas2Frm.LookBebanUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.QBeban.Close;
...
procedure TBukuKas2Frm.LookBebanUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.QBeban.Close;
...
procedure TBukuKas2Frm.cbPostClick(Sender: TObject);
begin
...
procedure TBukuKas2Frm.QDetailBeforeEdit(DataSet: TDataSet);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TBukuKas2Frm.FormShow(Sender: TObject);
begin
  VTglAwal2.Date:=Date;
end;
