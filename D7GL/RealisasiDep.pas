...
var
  RealisasiDepFrm: TRealisasiDepFrm;
...
procedure TRealisasiDepFrm.FormClose(Sender: TObject;
...
procedure TRealisasiDepFrm.FormShow(Sender: TObject);
begin
Mozilla.Refresh;
