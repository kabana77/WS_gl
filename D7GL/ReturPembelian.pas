...
procedure TReturPembelianFrm.FormClose(Sender: TObject;
...
procedure TReturPembelianFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TReturPembelianFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TReturPembelianFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TReturPembelianFrm.ECariChange(Sender: TObject);
begin
...
procedure TReturPembelianFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TReturPembelianFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vdebet, vkredit : real;
...
procedure TReturPembelianFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TReturPembelianFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TReturPembelianFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TReturPembelianFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TReturPembelianFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TReturPembelianFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TReturPembelianFrm.QDetailAfterScroll(DataSet: TDataSet);
begin
...
procedure TReturPembelianFrm.QTransaksiNewRecord(DataSet: TDataSet);
begin
  QTransaksiKD_PERK.AsString:=DMFrm.ckd_perk_hutang;
  QTransaksiTANGGAL.AsDateTime:=Date;
  QTransaksiJENIS.AsString:='REB';
...
procedure TReturPembelianFrm.DBMemo1KeyPress(Sender: TObject; var Key: Char);
begin
   if Key = #13 then
...
procedure TReturPembelianFrm.QTransaksiBeforePost(DataSet: TDataSet);
begin
...
procedure TReturPembelianFrm.MywwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TReturPembelianFrm.MywwDBGrid2Enter(Sender: TObject);
begin
  if QTransaksi.State<>dsBrowse then QTransaksi.Post;
end;

procedure TReturPembelianFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  if vno_bukti<>'' then
...
//  QDetailKREDIT.AsFloat:=0;
  ...
  QDetailQTY_IN.AsFloat:=1;
  if QTransaksiJENIS.AsString='HUT' then
    QDetailKD_PERK.AsString:=DMFrm.ckd_perk_hutang
    else
      QDetailKD_PERK.AsString:=DMFrm.ckd_perk_reb;
  QDetailNO_PROYEK.AsInteger:=2;
  QDetailKD_RAB.AsString:=QDetailKD_PERK.AsString;

end;

procedure TReturPembelianFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TReturPembelianFrm.QTransaksiAfterScroll(DataSet: TDataSet);
begin
  if QDetail.Active then
    MywwDBGrid2UpdateFooter(nil);
end;

procedure TReturPembelianFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TReturPembelianFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TReturPembelianFrm.QAwalBeforeOpen(DataSet: TDataSet);
begin
  QAwal.SetVariable('pawal',trunc(VTglAwal.Date));
  QAwal.SetVariable('kd_perk',QRekananKD_REKANAN.AsInteger);
end;

procedure TReturPembelianFrm.QBukuKasBeforeOpen(DataSet: TDataSet);
begin
...
procedure TReturPembelianFrm.BitBtn2Click(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  QAwal.Close;
...
procedure TReturPembelianFrm.DetailBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
...
begin
  if LookJenis.Text='FAKTUR' then
    QRLTitle2.Caption:='FAKTUR PEMBELIAN'
    else
      QRLTitle2.Caption:='RETUR PEMBELIAN';
end;

procedure TReturPembelianFrm.TitleBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TReturPembelianFrm.SummaryBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TReturPembelianFrm.VTglAwal2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TReturPembelianFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TReturPembelianFrm.cbTanggalClick(Sender: TObject);
begin
  if cbTanggal.Checked then
  begin
...
procedure TReturPembelianFrm.LookDivisiEnter(Sender: TObject);
begin
  DMFrm.QDivisi.Open;
end;

procedure TReturPembelianFrm.QDetailKD_BEBANChange(Sender: TField);
begin
  QDetailKETERANGAN.AsString:=DMFrm.QBebanKETERANGAN.AsString;
end;

procedure TReturPembelianFrm.QDetailNO_PROYEKChange(Sender: TField);
begin
  QDetailKETERANGAN.AsString:=DMFrm.QProyekNAMA_PEKERJAAN.AsString;
end;

procedure TReturPembelianFrm.cbPostClick(Sender: TObject);
begin
...
procedure TReturPembelianFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
  if QTransaksiISPOST.AsString='1' then
  begin
...
procedure TReturPembelianFrm.FormShow(Sender: TObject);
begin
  VTglAwal2.Date:=Date;
end;

procedure TReturPembelianFrm.QDetailCalcFields(DataSet: TDataSet);
begin
  QDetailSUB_TOTAL.AsFloat:=QDetailNILAI.AsFloat*QDetailQTY_IN.AsFloat;
end;

procedure TReturPembelianFrm.LookKaryawanEnter(Sender: TObject);
begin
  DMFrm.QKaryawan.Open;
end;

procedure TReturPembelianFrm.QTransaksiNHARIChange(Sender: TField);
begin
  QTransaksiJTH_TEMPO.AsDateTime:=QTransaksiTANGGAL.AsDateTime+QTransaksiNHARI.AsInteger;
end;

procedure TReturPembelianFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TReturPembelianFrm.LookRekanan2Enter(Sender: TObject);
begin
  QRekanan.Open;
end;

procedure TReturPembelianFrm.LookItemUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.QItem.Close;
  DMFrm.QItem.Open;
...
procedure TReturPembelianFrm.LookItemEnter(Sender: TObject);
begin
  QItem.Close;
...
procedure TReturPembelianFrm.LookRekananCloseUp(Sender: TObject;
...
procedure TReturPembelianFrm.LookLokasiEnter(Sender: TObject);
begin
  DMFrm.QLokasi.Open;
end;

procedure TReturPembelianFrm.LookDivisiKeyPress(Sender: TObject;
  var Key: Char);
begin
   if Key = #13 then
   begin
...
procedure TReturPembelianFrm.LookRekananEnter(Sender: TObject);
begin
  QRekanan.Open;
end;
