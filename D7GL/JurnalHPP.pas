...
type
  TJurnalHPPFrm = class(TForm)
    ...
    QBrowse4NOMOR_JURNAL: TIntegerField;
    ...
    QBrowse4ISHEAD: TStringField;
    QBrowse4KAS: TStringField;
    QBrowse4JENIS: TStringField;
    QBrowse4NO_BUKTI: TStringField;
    QuickRep4: TQuickRep;
    QRBand2: TQRBand;
    QRBand5: TQRBand;
    QRBand6: TQRBand;
    ...
    QBrowse4KD_REKANAN: TIntegerField;
    ...
    QBrowse4KD_BIAYA: TStringField;
    QBrowseKD_BIAYA: TStringField;
    QBrowse4KD_CF: TStringField;
    QBrowse4NM_CF: TStringField;
    BitBtn3: TBitBtn;
  ...
  private
    ...
    vfilter, vfilter2, vorder, vno_bukti, vJur : String;
    vnomer : Integer;
    vselisih : Real;
    vDeb,vKre : real;
...
procedure TJurnalHPPFrm.FormClose(Sender: TObject;
...
procedure TJurnalHPPFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TJurnalHPPFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TJurnalHPPFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TJurnalHPPFrm.ECariChange(Sender: TObject);
begin
...
procedure TJurnalHPPFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TJurnalHPPFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vdebet, vkredit : real;
...
procedure TJurnalHPPFrm.BitBtn5Click(Sender: TObject);
begin
...
{azmi}
  QTransaksi.SetVariable('no_reg',QBrowse4NOMOR_JURNAL.AsInteger);
{azmi}
...
procedure TJurnalHPPFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TJurnalHPPFrm.wwDBGrid2Enter(Sender: TObject);
begin
  if QTransaksi.State<>dsBrowse then QTransaksi.Post;
end;

procedure TJurnalHPPFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TJurnalHPPFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TJurnalHPPFrm.LookProyekEnter(Sender: TObject);
begin
  DMFrm.QProyek.Open;
end;

procedure TJurnalHPPFrm.LookRABEnter(Sender: TObject);
begin
  DMFrm.QRab.Close;
...
procedure TJurnalHPPFrm.QDetailKD_RABChange(Sender: TField);
begin
...
procedure TJurnalHPPFrm.LookCashflowEnter(Sender: TObject);
begin
//  DMFrm.QCashflow.Open;
end;

procedure TJurnalHPPFrm.LookPerkiraanEnter(Sender: TObject);
begin
  DMFrm.QPerkiraan.Open;

end;

procedure TJurnalHPPFrm.LookRABUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  LookupTable.Close;
  LookupTable.Open;
...
procedure TJurnalHPPFrm.QTransaksiAfterScroll(DataSet: TDataSet);
begin
  if QDetail.Active then
    wwDBGrid2UpdateFooter(nil);
end;

procedure TJurnalHPPFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TJurnalHPPFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=Trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TJurnalHPPFrm.QAwalBeforeOpen(DataSet: TDataSet);
begin
  QAwal.SetVariable('pawal',trunc(VTglAwal.Date));
  QAwal.SetVariable('kd_perk',DMFrm.QKasKD_PERK.AsString);
end;

procedure TJurnalHPPFrm.QBukuKasBeforeOpen(DataSet: TDataSet);
begin
...
procedure TJurnalHPPFrm.BitBtn2Click(Sender: TObject);
var
  vdebet, vkredit : real;
begin
  QAwal.Close;
...
procedure TJurnalHPPFrm.wwDBLookupCombo1Enter(Sender: TObject);
begin
  DMFrm.QPerkiraan.Open;
end;

procedure TJurnalHPPFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  L_Record.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TJurnalHPPFrm.wwDBGrid1DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
...
procedure TJurnalHPPFrm.VTglAwal4Change(Sender: TObject);
begin
{azmi}
...
procedure TJurnalHPPFrm.vTglAkhir4Change(Sender: TObject);
begin
{azmi}
...
procedure TJurnalHPPFrm.cbOtomatis4Click(Sender: TObject);
begin
{azmi}
...
procedure TJurnalHPPFrm.dbcField4Enter(Sender: TObject);
var
  i : Word;
begin
{azmi}
...
procedure TJurnalHPPFrm.vOperand4Click(Sender: TObject);
begin
{azmi}
...
procedure TJurnalHPPFrm.cbTanggal4Click(Sender: TObject);
begin
{azmi}
...
procedure TJurnalHPPFrm.ECari4Change(Sender: TObject);
begin
{azmi}
  if cbOtomatis4.Checked then
  begin
...
procedure TJurnalHPPFrm.BitBtn4Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vdebet, vkredit : real;
...
{azmi}
  ...
  begin
    ...
    vfilter:=vfilter+')';
    vorder:=' order by nomor_jurnal, tanggal, kredit';
...
//  2 : vJur:=' and no_bukti like '+'''995-%''';
  2 : vJur:=' and (no_bukti like '+'''995-%'''+' or no_bukti like '+'''996-%'''+' or no_bukti like '+'''997-%'''+')';
  3 : vJur:=' and no_nota like '+'''BB%''';
  4 : vJur:=' and no_nota like '+'''BK%''';
  5 : vJur:=' and (no_nota like '+'''505-%'''+' or no_nota like '+'''506-%'''+')';
  6 : vJur:=' and no_nota like '+'''BC%''';
  7 : vJur:=' and no_nota like '+'''MEM%''';
  8 : vJur:=' and jenis like '+'''BAJ''';
  9 : vJur:='';
...
procedure TJurnalHPPFrm.TabSheet4Show(Sender: TObject);
begin
{azmi}
...
procedure TJurnalHPPFrm.QRBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
...
procedure TJurnalHPPFrm.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
      vdeb:=0;
      vkre:=0;
    ...
    6 : QRLJur.Caption:='JURNAL BG';
    7 : QRLJur.Caption:='JURNAL MEM';
    8 : QRLJur.Caption:='JURNAL BAJ';
    9 : QRLJur.Caption:='JURNAL';
    end;
end;

procedure TJurnalHPPFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TJurnalHPPFrm.LookPerkiraanKasEnter(Sender: TObject);
begin
{azmi}
QPerkiraan.Open;
{azmi}
...
procedure TJurnalHPPFrm.QTransaksiAfterPost(DataSet: TDataSet);
begin
{azmi}
  QUpdate.Close;
...
procedure TJurnalHPPFrm.QDetailKD_PERKChange(Sender: TField);
begin
{azmi}
...
procedure TJurnalHPPFrm.DBText1Click(Sender: TObject);
begin
{azmi}
...
procedure TJurnalHPPFrm.LookBagianEnter(Sender: TObject);
begin
{DMFrm.}QLookDept.Open;
end;

procedure TJurnalHPPFrm.LookBudgetEnter(Sender: TObject);
begin
...
procedure TJurnalHPPFrm.BitBtn3Click(Sender: TObject);
begin
...
procedure TJurnalHPPFrm.wwDBGrid4TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
     if (Sender as TwwDBGrid).DataSource.DataSet.FieldByName(AFieldName).FieldKind=fkData then
        begin
          ...
          (Sender as TwwDBGrid).DataSource.DataSet.DisableControls;
          (Sender as TwwDBGrid).DataSource.DataSet.Close;
          ((Sender as TwwDBGrid).DataSource.DataSet as TOracleDataSet).SetVariable('myparam',vfilter+vJur+' order by '+(Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName+vorder);
          (Sender as TwwDBGrid).DataSource.DataSet.Open;
          (Sender as TwwDBGrid).DataSource.DataSet.EnableControls;
        end
        else
