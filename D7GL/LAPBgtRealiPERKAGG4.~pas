...
type
  TLAPBgtRealiPERKAGG4FRM = class(TForm)
    Panel1: TPanel;
...
var
  LAPBgtRealiPERKAGG4FRM: TLAPBgtRealiPERKAGG4FRM;
...
procedure TLAPBgtRealiPERKAGG4FRM.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  LAPBgtRealiPERKAGG4FRM:=Nil;
end;

procedure TLAPBgtRealiPERKAGG4FRM.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TLAPBgtRealiPERKAGG4FRM.BitBtn5Click(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.TabSheet1Show(Sender: TObject);
//VAR
//vTOT:REAL;
begin
{QProses1.Close;
...
procedure TLAPBgtRealiPERKAGG4FRM.vHeightAfterUpClick(Sender: TObject);
begin
  //case PageControl1.ActivePageIndex of
...
procedure TLAPBgtRealiPERKAGG4FRM.BtnExportClick(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.QDetailAfterScroll(DataSet: TDataSet);
begin
//  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TLAPBgtRealiPERKAGG4FRM.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  tanggalan : string;
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  tanggalan : string;
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  //QRImage1.Picture.Assign(DMFrm.vlogo.Picture);
end;

procedure TLAPBgtRealiPERKAGG4FRM.BitBtn3Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses1.Close;
QProses1.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses1.SetVariable('panggaran','CASHFLOW');
...
procedure TLAPBgtRealiPERKAGG4FRM.TabSheet2Show(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.et3Show(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.BitBtn4Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses.Close;
QProses.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses.SetVariable('panggaran','CASHFLOW');
...
procedure TLAPBgtRealiPERKAGG4FRM.QRekapBudgetRealPerkCalcFields(DataSet: TDataSet);
begin
{ JHN }
...
procedure TLAPBgtRealiPERKAGG4FRM.QRealisasiBgtCalcFields(DataSet: TDataSet);
begin
{azmi}
...
procedure TLAPBgtRealiPERKAGG4FRM.CheckBox1Click(Sender: TObject);
begin
 // QBrowse.Filtered:=CheckBox1.Checked;
end;

procedure TLAPBgtRealiPERKAGG4FRM.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=((QBrowseBIAYA_BGT.AsFloat)>0);
end;

procedure TLAPBgtRealiPERKAGG4FRM.BitBtn2Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses2.Close;
QProses2.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses2.SetVariable('panggaran','CASHFLOW');
...
procedure TLAPBgtRealiPERKAGG4FRM.CheckBox2Click(Sender: TObject);
begin
 // QBrowse4.Filtered:=CheckBox2.Checked;
end;

procedure TLAPBgtRealiPERKAGG4FRM.QBrowse4FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=((QBrowse4REALISASI.AsFloat)>0);
end;

procedure TLAPBgtRealiPERKAGG4FRM.TabSheet4Show(Sender: TObject);
begin
{QDaftarBiaya.Close;
QDaftarBiaya.Open;
...
procedure TLAPBgtRealiPERKAGG4FRM.BitBtn6Click(Sender: TObject);
begin
  edCari3.Clear;
  edCari5.Clear;
 // edCari4.Clear;
...
procedure TLAPBgtRealiPERKAGG4FRM.CheckBox3Click(Sender: TObject);
begin
 // QBrowse5.Filtered:=CheckBox3.Checked;
end;

procedure TLAPBgtRealiPERKAGG4FRM.QTotal2CalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.LookPerkiraanEnter(Sender: TObject);
begin
  QPerkBudget.Open;
end;

procedure TLAPBgtRealiPERKAGG4FRM.lookDeptClick(Sender: TObject);
begin
   lookDept.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
   lookDept2.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
end;

procedure TLAPBgtRealiPERKAGG4FRM.lookDeptCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.lookDeptEnter(Sender: TObject);
begin
    DMFrm.QLook_Dept.Open;
end;

procedure TLAPBgtRealiPERKAGG4FRM.lookSubDeptClick(Sender: TObject);
begin
    lookDept.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
    lookDept2.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
end;

procedure TLAPBgtRealiPERKAGG4FRM.lookSubDeptCloseUp(Sender: TObject;
...
procedure TLAPBgtRealiPERKAGG4FRM.lookSubDeptEnter(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.Button1Click(Sender: TObject);
begin
  edCari1.Clear;
  edCari2.Clear;
  edCari6.Clear;
...
procedure TLAPBgtRealiPERKAGG4FRM.QRekapDepartemenCalcFields(
  DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.QTotDepCalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.wwDBGrid4DblClick(Sender: TObject);
var
...
procedure TLAPBgtRealiPERKAGG4FRM.BitBtn1Click(Sender: TObject);
begin
QProsesBReal.Close;
...
procedure TLAPBgtRealiPERKAGG4FRM.LookPerkiraanCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
edCari5.Text:=QPerkBudgetKD_PERK.AsString;
end;

procedure TLAPBgtRealiPERKAGG4FRM.LookPerkiraan2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
edCari6.Text:=QPerkBudgetKD_PERK.AsString;
end;

procedure TLAPBgtRealiPERKAGG4FRM.SpinEdit1Change(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG4FRM.wwDBGrid3DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
