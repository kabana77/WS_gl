object LAPBgtRealiPERKAGG2FRM: TLAPBgtRealiPERKAGG2FRM
  Left = 340
  Top = 116
  Width = 1024
  Height = 594
  ...
  object QProses: TOracleQuery
    SQL.Strings = (
      ...
      '  commit;'
        ...
        '  cip_budgeting.proc_lap_aggreal_dept(:ptahun,:puser,:panggaran,' +
        ':pdept,:pkdperk);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QProses1: TOracleQuery
    SQL.Strings = (
      ...
      '  commit;'
        ...
        '  cip_budgeting.proc_lap_aggreal_dept_detail(:ptahun,:puser,:pan' +
        'ggaran,:pdept,:pkdperk);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000005000000060000003A50555345520500000000000000000000000A00
  ...
  object QPerkBudget: TOracleDataSet
    SQL.Strings = (
      ...
      'where a.kel_budget='#39'ANGGARAN OPERASIONAL'#39
      'order by kd_perk')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QProses2: TOracleQuery
    SQL.Strings = (
      ...
      '  commit;'
        ...
        '  cip_budgeting.proc_lap_aggreal_subdept(:ptahun,:puser,:panggar' +
        'an,:pdept,:psubdept,:pkdperk);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
