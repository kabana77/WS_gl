...
type
  TLAPBgtRealiPERKAGG3FRM = class(TForm)
    Panel1: TPanel;
...
var
  LAPBgtRealiPERKAGG3FRM: TLAPBgtRealiPERKAGG3FRM;
...
procedure TLAPBgtRealiPERKAGG3FRM.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  LAPBgtRealiPERKAGG3FRM:=Nil;
end;

procedure TLAPBgtRealiPERKAGG3FRM.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TLAPBgtRealiPERKAGG3FRM.BitBtn5Click(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.TabSheet1Show(Sender: TObject);
//VAR
//vTOT:REAL;
begin
{QProses1.Close;
...
procedure TLAPBgtRealiPERKAGG3FRM.vHeightAfterUpClick(Sender: TObject);
begin
  //case PageControl1.ActivePageIndex of
...
procedure TLAPBgtRealiPERKAGG3FRM.BtnExportClick(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.QDetailAfterScroll(DataSet: TDataSet);
begin
//  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TLAPBgtRealiPERKAGG3FRM.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  tanggalan : string;
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  tanggalan : string;
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  //QRImage1.Picture.Assign(DMFrm.vlogo.Picture);
end;

procedure TLAPBgtRealiPERKAGG3FRM.BitBtn3Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses1.Close;
QProses1.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses1.SetVariable('panggaran','ANGGARAN INVESTASI');
...
procedure TLAPBgtRealiPERKAGG3FRM.TabSheet2Show(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.et3Show(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.BitBtn4Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses.Close;
QProses.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses.SetVariable('panggaran','ANGGARAN INVESTASI');
...
procedure TLAPBgtRealiPERKAGG3FRM.QRekapBudgetRealPerkCalcFields(DataSet: TDataSet);
begin
{ JHN }
...
procedure TLAPBgtRealiPERKAGG3FRM.QRealisasiBgtCalcFields(DataSet: TDataSet);
begin
{azmi}
...
procedure TLAPBgtRealiPERKAGG3FRM.CheckBox1Click(Sender: TObject);
begin
 // QBrowse.Filtered:=CheckBox1.Checked;
end;

procedure TLAPBgtRealiPERKAGG3FRM.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=((QBrowseBIAYA_BGT.AsFloat)>0);
end;

procedure TLAPBgtRealiPERKAGG3FRM.BitBtn2Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses2.Close;
QProses2.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses2.SetVariable('panggaran','ANGGARAN INVESTASI');
...
procedure TLAPBgtRealiPERKAGG3FRM.CheckBox2Click(Sender: TObject);
begin
 // QBrowse4.Filtered:=CheckBox2.Checked;
end;

procedure TLAPBgtRealiPERKAGG3FRM.QBrowse4FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=((QBrowse4REALISASI.AsFloat)>0);
end;

procedure TLAPBgtRealiPERKAGG3FRM.TabSheet4Show(Sender: TObject);
begin
{QDaftarBiaya.Close;
QDaftarBiaya.Open;
...
procedure TLAPBgtRealiPERKAGG3FRM.BitBtn6Click(Sender: TObject);
begin
  edCari3.Clear;
  edCari5.Clear;
 // edCari4.Clear;
...
procedure TLAPBgtRealiPERKAGG3FRM.CheckBox3Click(Sender: TObject);
begin
 // QBrowse5.Filtered:=CheckBox3.Checked;
end;

procedure TLAPBgtRealiPERKAGG3FRM.QTotal2CalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.LookPerkiraanEnter(Sender: TObject);
begin
  QPerkBudget.Open;
end;

procedure TLAPBgtRealiPERKAGG3FRM.lookDeptClick(Sender: TObject);
begin
   lookDept.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
   lookDept2.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
end;

procedure TLAPBgtRealiPERKAGG3FRM.lookDeptCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.lookDeptEnter(Sender: TObject);
begin
    DMFrm.QLook_Dept.Open;
end;

procedure TLAPBgtRealiPERKAGG3FRM.lookSubDeptClick(Sender: TObject);
begin
    lookDept.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
    lookDept2.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
end;

procedure TLAPBgtRealiPERKAGG3FRM.lookSubDeptCloseUp(Sender: TObject;
...
procedure TLAPBgtRealiPERKAGG3FRM.lookSubDeptEnter(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.Button1Click(Sender: TObject);
begin
  edCari1.Clear;
  edCari2.Clear;
  edCari6.Clear;
...
procedure TLAPBgtRealiPERKAGG3FRM.QRekapDepartemenCalcFields(
  DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.QTotDepCalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.wwDBGrid4DblClick(Sender: TObject);
var
...
procedure TLAPBgtRealiPERKAGG3FRM.BitBtn1Click(Sender: TObject);
begin
QProsesBReal.Close;
...
procedure TLAPBgtRealiPERKAGG3FRM.LookPerkiraanCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
edCari5.Text:=QPerkBudgetKD_PERK.AsString;
end;

procedure TLAPBgtRealiPERKAGG3FRM.LookPerkiraan2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
edCari6.Text:=QPerkBudgetKD_PERK.AsString;
end;

procedure TLAPBgtRealiPERKAGG3FRM.SpinEdit1Change(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGG3FRM.wwDBGrid3DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
