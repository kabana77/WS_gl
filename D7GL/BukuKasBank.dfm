object BukuKasBankFrm: TBukuKasBankFrm
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      ...
      '1 as vcount,'
      'b.awal as awal, c.debet, c.kredit from vkasbank a '
      
        'left outer join (select p.kd_perk, sum(p.debet-p.kredit) as awal' +
        ' '
      
        '  from jurnal p, kas q where p.no_kas=q.no_kas and q.tanggal<tru' +
        'nc(:pawal)'
    ...
    object QBrowseVGROUP: TStringField
      FieldName = 'VGROUP'
      Size = 9
    end
    object QBrowseLNAMA_PERKIRAAN: TStringField
