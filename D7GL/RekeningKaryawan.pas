...
type
  TRekeningKaryawanFrm = class(TForm)
    Panel1: TPanel;
...
var
  RekeningKaryawanFrm: TRekeningKaryawanFrm;
...
procedure TRekeningKaryawanFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  RekeningKaryawanFrm:=Nil;
end;

procedure TRekeningKaryawanFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TRekeningKaryawanFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TRekeningKaryawanFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TRekeningKaryawanFrm.ECariChange(Sender: TObject);
begin
...
procedure TRekeningKaryawanFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TRekeningKaryawanFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
...
procedure TRekeningKaryawanFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TRekeningKaryawanFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TRekeningKaryawanFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TRekeningKaryawanFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TRekeningKaryawanFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TRekeningKaryawanFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TRekeningKaryawanFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TRekeningKaryawanFrm.QDetailAfterScroll(DataSet: TDataSet);
begin
//  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TRekeningKaryawanFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRekeningKaryawanFrm.VTglAwal2Change(Sender: TObject);
begin
  vTglAkhir2.Date:=Trunc(EndOfTheMonth(VTglAwal2.Date));
end;

procedure TRekeningKaryawanFrm.vTglAkhir2Change(Sender: TObject);
begin
...
procedure TRekeningKaryawanFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseAKHIR.AsFloat:=QBrowseAWAL.AsFloat+
    QBrowseDEBET.AsFloat-QBrowseKREDIT.AsFloat;
end;

procedure TRekeningKaryawanFrm.QBrowseBeforeOpen(DataSet: TDataSet);
begin
  QBrowse.SetVariable('pawal',VTglAwal2.Date);
  QBrowse.SetVariable('pakhir',VTglAkhir2.Date);
end;

procedure TRekeningKaryawanFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRExpr5.Reset;
end;

procedure TRekeningKaryawanFrm.LookPerkiraanEnter(Sender: TObject);
begin
