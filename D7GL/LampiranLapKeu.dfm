object LampiranLapKeuFrm: TLampiranLapKeuFrm
  Left = 179
  Top = 147
  Width = 881
  Height = 591
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = 'LAPORAN HARGA POKOK PENJUALAN'
      ...
      object QuickRep2_BackQR1: TQuickRep
        Left = 94
        Top = 206
        Width = 1123
        Height = 794
        ...
        object QRBand1: TQRBand
          ...
          object QRLabel6: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'LAPORAN PERHITUNGAN LABA (RUGI)'
            Color = clWhite
            Font.Charset = ANSI_CHARSET
            Font.Color = clWindowText
            Font.Height = -16
      ...
      object MywwDBGrid10: TwwDBGrid
        ...
        Selected.Strings = (
          'KD_RAB'#9'7'#9'Kode'#9'F'
          'KD_PERK'#9'20'#9'Kode~Perkiraan'#9'F'
          'KETERANGAN'#9'50'#9'KETERANGAN'#9'F'
          'AKTUAL_MUTASI'#9'15'#9'IDR'#9'F'#9'BULAN INI'
          'AKTUAL_PSN'#9'3'#9'%'#9'F'#9'BULAN INI'
          'AKTUAL_MUTASI2'#9'15'#9'IDR'#9'F'#9'BULAN LALU'
          'AKTUAL_PSN2'#9'3'#9'%'#9'F'#9'BULAN LALU'
          'AKTUAL_MUTASI3'#9'15'#9'IDR'#9'F'#9'S/D BULAN INI'
          'AKTUAL_PSN3'#9'3'#9'%'#9'F'#9'S/D BULAN INI')
        ...
        OnURLOpen = MywwDBGrid10URLOpen
        GroupFieldName = 'NO_NOTA'
      end
    end
    object TabSheet2: TTabSheet
      Caption = 'Penjelasan RL'
      ImageIndex = 1
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from rab_real1 order by ibaris')
    QBEDefinition.QBEFieldDefs = {
      040000001D00000006000000494241524953010000000000060000004B445F52
      ...
      00000000080000005641525F50534E34010000000000070000004B445F504552
      4B01000000000006000000565155455259010000000000}
  ...
  object QProc_Neraca2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  commit;'
      '  proc_rep_lampkeu(:ptahun,:pbulan);'
      '  proc_rep_lampkeu_hpp_det;'
      'end;'
      '')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QBrowse2: TOracleDataSet
    SQL.Strings = (
      ...
      'from saldo_perkiraan a'
        ...
        'pawal) and q.tanggal<=trunc(:pakhir)+1-1/86400 group by p.kd_per' +
        'k) b'
  ...
  object QProc_Neraca3: TOracleQuery
    SQL.Strings = (
      'begin'
      '  commit;'
      '  proc_rep_lampkeu(:ptahun,:pbulan);'
      '  proc_rep_lampkeu_hpp;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000002000000070000003A50544148554E0300000004000000D907000000
