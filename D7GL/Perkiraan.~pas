...
type
  TPerkiraanFrm = class(TForm)
    ...
    QBrowseNM_PERK_PUSAT: TStringField;
    QBrowseLVL_PUSAT: TIntegerField;
    QBrowseISDETAIL_PUSAT: TStringField;
...
procedure TPerkiraanFrm.FormClose(Sender: TObject;
...
procedure TPerkiraanFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPerkiraanFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TPerkiraanFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TPerkiraanFrm.ECariChange(Sender: TObject);
begin
...
procedure TPerkiraanFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TPerkiraanFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
