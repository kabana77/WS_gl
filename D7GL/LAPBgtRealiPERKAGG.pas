...
type
  TLAPBgtRealiPERKAGGFRM = class(TForm)
    Panel1: TPanel;
...
var
  LAPBgtRealiPERKAGGFRM: TLAPBgtRealiPERKAGGFRM;
...
procedure TLAPBgtRealiPERKAGGFRM.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  LAPBgtRealiPERKAGGFRM:=Nil;
end;

procedure TLAPBgtRealiPERKAGGFRM.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TLAPBgtRealiPERKAGGFRM.BitBtn5Click(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.TabSheet1Show(Sender: TObject);
//VAR
//vTOT:REAL;
begin
{QProses1.Close;
...
procedure TLAPBgtRealiPERKAGGFRM.vHeightAfterUpClick(Sender: TObject);
begin
  //case PageControl1.ActivePageIndex of
...
procedure TLAPBgtRealiPERKAGGFRM.BtnExportClick(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TLAPBgtRealiPERKAGGFRM.QDetailAfterScroll(DataSet: TDataSet);
begin
//  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TLAPBgtRealiPERKAGGFRM.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.ColumnHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  tanggalan : string;
begin
...
procedure TLAPBgtRealiPERKAGGFRM.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
  tanggalan : string;
begin
...
procedure TLAPBgtRealiPERKAGGFRM.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  //QRImage1.Picture.Assign(DMFrm.vlogo.Picture);
end;

procedure TLAPBgtRealiPERKAGGFRM.BitBtn3Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses1.Close;
QProses1.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses1.SetVariable('panggaran','ANGGARAN PEMBELIAN');
...
procedure TLAPBgtRealiPERKAGGFRM.TabSheet2Show(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.et3Show(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.BitBtn4Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses.Close;
QProses.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses.SetVariable('panggaran','ANGGARAN PEMBELIAN');
...
procedure TLAPBgtRealiPERKAGGFRM.QRekapBudgetRealPerkCalcFields(DataSet: TDataSet);
begin
{ JHN }
...
procedure TLAPBgtRealiPERKAGGFRM.QRealisasiBgtCalcFields(DataSet: TDataSet);
begin
{azmi}
...
procedure TLAPBgtRealiPERKAGGFRM.CheckBox1Click(Sender: TObject);
begin
 // QBrowse.Filtered:=CheckBox1.Checked;
end;

procedure TLAPBgtRealiPERKAGGFRM.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=((QBrowseBIAYA_BGT.AsFloat)>0);
end;

procedure TLAPBgtRealiPERKAGGFRM.BitBtn2Click(Sender: TObject);
VAR
vTOT:REAL;
begin
QProses2.Close;
QProses2.SetVariable('puser',DMFRM.QUserNAMA_USER.AsString);
QProses2.SetVariable('panggaran','ANGGARAN PEMBELIAN');
...
procedure TLAPBgtRealiPERKAGGFRM.CheckBox2Click(Sender: TObject);
begin
 // QBrowse4.Filtered:=CheckBox2.Checked;
end;

procedure TLAPBgtRealiPERKAGGFRM.QBrowse4FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=((QBrowse4REALISASI.AsFloat)>0);
end;

procedure TLAPBgtRealiPERKAGGFRM.TabSheet4Show(Sender: TObject);
begin
{QDaftarBiaya.Close;
QDaftarBiaya.Open;
...
procedure TLAPBgtRealiPERKAGGFRM.BitBtn6Click(Sender: TObject);
begin
  edCari3.Clear;
  edCari5.Clear;
 // edCari4.Clear;
...
procedure TLAPBgtRealiPERKAGGFRM.CheckBox3Click(Sender: TObject);
begin
 // QBrowse5.Filtered:=CheckBox3.Checked;
end;

procedure TLAPBgtRealiPERKAGGFRM.QTotal2CalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.LookPerkiraanEnter(Sender: TObject);
begin
  QPerkBudget.Open;
end;

procedure TLAPBgtRealiPERKAGGFRM.lookDeptClick(Sender: TObject);
begin
   lookDept.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
   lookDept2.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
end;

procedure TLAPBgtRealiPERKAGGFRM.lookDeptCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.lookDeptEnter(Sender: TObject);
begin
    DMFrm.QLook_Dept.Open;
end;

procedure TLAPBgtRealiPERKAGGFRM.lookSubDeptClick(Sender: TObject);
begin
    lookDept.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
    lookDept2.Caption:=DMFrm.QLook_DeptNAMA_DEPT.AsString;
end;

procedure TLAPBgtRealiPERKAGGFRM.lookSubDeptCloseUp(Sender: TObject;
...
procedure TLAPBgtRealiPERKAGGFRM.lookSubDeptEnter(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.Button1Click(Sender: TObject);
begin
  edCari1.Clear;
  edCari2.Clear;
  edCari6.Clear;
...
procedure TLAPBgtRealiPERKAGGFRM.QRekapDepartemenCalcFields(
  DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.QTotDepCalcFields(DataSet: TDataSet);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.wwDBGrid4DblClick(Sender: TObject);
var
...
procedure TLAPBgtRealiPERKAGGFRM.BitBtn1Click(Sender: TObject);
begin
QProsesBReal.Close;
...
procedure TLAPBgtRealiPERKAGGFRM.LookPerkiraanCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
edCari5.Text:=QPerkBudgetKD_PERK.AsString;
end;

procedure TLAPBgtRealiPERKAGGFRM.LookPerkiraan2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
edCari6.Text:=QPerkBudgetKD_PERK.AsString;
end;

procedure TLAPBgtRealiPERKAGGFRM.SpinEdit1Change(Sender: TObject);
begin
...
procedure TLAPBgtRealiPERKAGGFRM.wwDBGrid3DblClick(Sender: TObject);
var
  myrvdDialog : TwwRecordViewDialog;
begin
  myrvdDialog:=TwwRecordViewDialog.Create(Nil);
