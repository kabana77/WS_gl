...
type
  TRekananFrm = class(TForm)
    ...
    QBrowseFAX: TStringField;
    QBrowseEMAIL: TStringField;
    QBrowseWEB: TStringField;
    QBrowseCTC_PERSON: TStringField;
...
procedure TRekananFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TRekananFrm.ECariChange(Sender: TObject);
begin
...
procedure TRekananFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TRekananFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TRekananFrm.QDetailAfterScroll(DataSet: TDataSet);
begin
//  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TRekananFrm.cbModeEditClick(Sender: TObject);
begin
...
procedure TRekananFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=Caption;
end;

procedure TRekananFrm.QBrowseNewRecord(DataSet: TDataSet);
begin
