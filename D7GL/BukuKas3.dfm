object BukuKas3Frm: TBukuKas3Frm
  Left = 160
  Top = 30
  Width = 714
  Height = 734
  Caption = 'JURNAL KAS BON'
  Color = clBtnFace
      ...
      object Panel6: TPanel
        ...
        object wwDBGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'KD_BEBAN'#9'14'#9'DIBEBANKAN KE'#9'F'
            'KETERANGAN'#9'56'#9'KETERANGAN'#9#9
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select a.* from vbrowse_kas_bon a'
      ':myparam')
    Variables.Data = {
  ...
  object QTransaksi: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from kas_bon a'
      'where no_kas=:no_reg')
    Variables.Data = {
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from jurnal_kas_bon a'
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(nilai) as total from jurnal_kas_bon'
      'where no_kas = :no_kas')
    Variables.Data = {0300000001000000070000003A4E4F5F4B4153030000000000000000000000}
  ...
  object QAwal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum((a.debet-a.kredit)*a.kurs) as awal from jurnal_kas_bo' +
        'n a, kas_bon b'
  ...
  object QBukuKas: TOracleDataSet
    SQL.Strings = (
        ...
        'select * from (select * from vbrowse_kas_bon where kas=:kd_perk_' +
        'kas and ishead='#39'0'#39
