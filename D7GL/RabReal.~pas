...
type
  TRabRealFrm = class(TForm)
    ...
    BitBtn7: TBitBtn;
    BitBtn8: TBitBtn;
    QProcRepPSAK: TOracleQuery;
    QProcDetPSAK: TOracleQuery;
...
procedure TRabRealFrm.FormClose(Sender: TObject;
...
procedure TRabRealFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TRabRealFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TRabRealFrm.BitBtn1Click(Sender: TObject);
var
...
procedure TRabRealFrm.BitBtn4Click(Sender: TObject);
var
  vtot11, vtot12, vtot21, vtot22 : Real;
begin
  isresume:=True;
...
procedure TRabRealFrm.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
SummaryBand1.Height:=4;
end;

procedure TRabRealFrm.PageFooterBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
PageFooterBand1.Height:=0;
end;

procedure TRabRealFrm.FormShow(Sender: TObject);
begin
  TabSheet2.TabVisible:=False;
   BitBtn4.Click();
end;

procedure TRabRealFrm.BitBtn6Click(Sender: TObject);
var
  vtot11, vtot12, vtot21, vtot22 : Real;
begin
  isresume:=True;
...
procedure TRabRealFrm.BitBtn7Click(Sender: TObject);
var
  vtot11, vtot12, vtot21, vtot22 : Real;
begin
  isresume:=True;
  QProcRepPSAK.Close;
  QProcRepPSAK.SetVariable('ptahun',Round(spTahun.Value));
  QProcRepPSAK.SetVariable('pbulan',FormatFloat('00',LookBulan.ItemIndex+1));
//  QProcRepPSAK.SetVariable('plevel',3);
  QProcRepPSAK.Execute;
  QBrowse.DisableControls;
  vtot11:=0;
  vtot12:=0;
  vtot21:=0;
...
procedure TRabRealFrm.BitBtn8Click(Sender: TObject);
var
  vtot11, vtot12, vtot21, vtot22 : Real;
begin
  isresume:=True;
  QProcDetPSAK.Close;
  QProcDetPSAK.SetVariable('ptahun',Round(spTahun.Value));
  QProcDetPSAK.SetVariable('pbulan',FormatFloat('00',LookBulan.ItemIndex+1));
 // QProcDetPSAK.SetVariable('plevel',3);
  QProcDetPSAK.Execute;
  QBrowse.DisableControls;
  vtot11:=0;
  vtot12:=0;
  vtot21:=0;
...
procedure TRabRealFrm.FormCreate(Sender: TObject);
begin
