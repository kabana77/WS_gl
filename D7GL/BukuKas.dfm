object BukuKasFrm: TBukuKasFrm
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KD_PERK'#9'10'#9'Kode Perkiraan'#9'F'#9'JURNAL CABANG'
          'NAMA_PERKIRAAN'#9'32'#9'Nama Perkiraan'#9'F'#9'JURNAL CABANG'
          'KD_REKANAN'#9'10'#9'REKANAN'#9'F'#9'KODE'
          'KD_CASH'#9'8'#9'CASHFLOW'#9'F'#9'KODE'
          'KAS'#9'8'#9'KAS'#9'F'#9'KODE'
          'KD_PERK_H'#9'10'#9'Kode Perkiraan'#9'F'#9'JURNAL GROUP'
          'NM_PERK_H'#9'32'#9'Nama Perkiraan'#9'F'#9'JURNAL GROUP'
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel6: TPanel
        ...
        object wwDBGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            'NO_BUKTI'#9'9'#9'NO_BUKTI'#9#9
            'NO_PROYEK'#9'6'#9'Proyek'#9'F'#9'DIBEBANKAN KE'
            'KD_RAB'#9'6'#9'Rab'#9'F'#9'DIBEBANKAN KE'
            'KD_DIV'#9'6'#9'Divisi'#9'F'#9'DIBEBANKAN KE'
            'KD_BEBAN'#9'8'#9'Jenis'#9'F'#9'DIBEBANKAN KE'
            'KETERANGAN'#9'35'#9'KETERANGAN'#9#9
            'KD_PERK'#9'8'#9'KD_PERK'#9#9
            'KD_CASH'#9'8'#9'KD_CASH'#9#9
            'NILAI'#9'13'#9'NILAI'#9#9
            'KURS'#9'5'#9'KURS'#9#9)
          IniAttributes.Enabled = True
          IniAttributes.SaveToRegistry = True
          IniAttributes.FileName = 'Cipsoft_GL'
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000110000000A00000054474C5F494E534552540100000000000A000000
      ...
      0000004B445F52454B414E414E010000000000}
  ...
  object QDetail: TOracleDataSet
    ...
    Variables.Data = {
      0300000001000000070000003A4E4F5F4B41530300000004000000C900000000
      000000}
    SequenceField.Field = 'NO_JURNAL'
    SequenceField.Sequence = 'NO_JURNAL'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      040000001E000000090000004E4F5F4A55524E414C010000000000080000004E
      ...
      00004E494C4149010000000000080000004B445F424542414E01000000000009
      0000004A4E535F424542414E010000000000}
    Master = QTransaksi
    MasterFields = 'NO_KAS'
    DetailFields = 'NO_KAS'
    RefreshOptions = [roAfterInsert, roAfterUpdate]
