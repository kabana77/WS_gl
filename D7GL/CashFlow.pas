...
uses
  ...
  Wwdbspin, Buttons, ExtCtrls, wwdblook, Wwdbdlg;
...
type
  TCashFlowFrm = class(TForm)
    ...
    QBrowseNAMA_CASHFLOW: TStringField;
...
procedure TCashFlowFrm.FormClose(Sender: TObject;
...
procedure TCashFlowFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TCashFlowFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
  if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TCashFlowFrm.wwDBGrid2CalcCellColors(Sender: TObject;
...
procedure TCashFlowFrm.ECariChange(Sender: TObject);
begin
...
procedure TCashFlowFrm.cbOtomatisClick(Sender: TObject);
begin
  if cbOtomatis.Checked then
  begin
...
procedure TCashFlowFrm.BitBtn1Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TCashFlowFrm.BitBtn5Click(Sender: TObject);
begin
...
procedure TCashFlowFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TCashFlowFrm.vHeightAfterUpClick(Sender: TObject);
begin
  case PageControl1.ActivePageIndex of
...
procedure TCashFlowFrm.BtnExportClick(Sender: TObject);
begin
  if QBrowse.Active then
  begin
...
procedure TCashFlowFrm.DBText5Click(Sender: TObject);
var
  DC : HDC;
  ABitmap:TBitmap;
begin
...
procedure TCashFlowFrm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TCashFlowFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TCashFlowFrm.QDetailAfterScroll(DataSet: TDataSet);
begin
//  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TCashFlowFrm.cbModeEditClick(Sender: TObject);
begin
...
procedure TCashFlowFrm.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TCashFlowFrm.QBrowseNewRecord(DataSet: TDataSet);
begin
...
procedure TCashFlowFrm.TitleBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLTitle.Caption:=Caption;
end;

procedure TCashFlowFrm.LookPerkiraanEnter(Sender: TObject);
begin
