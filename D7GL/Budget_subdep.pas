...
var
  BudgetsubdepFrm: TBudgetsubdepFrm;
...
procedure TBudgetsubdepFrm.FormClose(Sender: TObject;
...
procedure TBudgetsubdepFrm.FormShow(Sender: TObject);
begin
Mozilla.Refresh;
Mozilla.Navigate('192.168.1.225\budgeting_link\budgeting\BUDGET_SUB.php');
